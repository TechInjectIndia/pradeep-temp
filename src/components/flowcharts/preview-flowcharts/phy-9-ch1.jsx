...
function Sidebar({ open, setOpen, tocItems }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding:"56px 0 20px", flexShrink:0 }}>
        <div style={{
          padding:"0 16px",
          fontFamily:"'Merriweather Sans',Arial,sans-serif",
      ...
      <nav style={{ padding:"0 0 8px", flex:1 }}>
        {tocItems.map(item => (
          <div
            key={item.id}
  ...
  <div style={{ position: "relative", marginTop: 30 }}>
    ...
    <div style={{
      ...
      <p style={{
        ...
        Sections 1.8–1.16 including Graphical Representation of Motion, Distance-Time Graphs, Velocity-Time Graphs, Derivation of Equations of Motion, Uniform Circular Motion and more.
      </p>
      <button style={{

...
const FIRST_NAMES = [
  'Pradeep', 'Suresh', 'Anita', 'Lakshmi', 'Rajesh',
  'Meera', 'Vikram', 'Pooja', 'Arun', 'Deepa',
  'Kavita', 'Sanjay', 'Nisha', 'Ravi', 'Sunita',
  'Amit', 'Priya', 'Manoj', 'Geeta', 'Rahul',
  'Neha', 'Ajay', 'Swati', 'Mohan', 'Rekha',
  'Vivek', 'Sneha', 'Ashok', 'Divya', 'Kiran',
  'Ramesh', 'Asha', 'Nitin', 'Smita', 'Gaurav',
  'Jyoti', 'Pankaj', 'Shweta', 'Sunil', 'Rina',
];

const LAST_NAMES = [
  'Sharma', 'Patel', 'Kumar', 'Singh', 'Gupta',
  'Verma', 'Reddy', 'Nair', 'Iyer', 'Joshi',
  'Mishra', 'Rao', 'Das', 'Pillai', 'Chatterjee',
  'Banerjee', 'Desai', 'Mehta', 'Thakur', 'Pandey',
];
...
const CITIES = [
  ...
  'Patna', 'Surat', 'Vadodara', 'Coimbatore', 'Visakhapatnam',
];

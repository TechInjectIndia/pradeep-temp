...
const SecHd = ({ id, label, title }) => (
  <div id={id} style={{ marginTop: 22, marginBottom: 10 }}>
    <h2 style={{ fontFamily: "'Merriweather Sans',Arial,sans-serif", fontSize: 14,
      fontWeight: 800, color: "#c0126a", textTransform: "uppercase",
...
const SubHd = ({ id, label, title }) => (
  <h3 id={id} style={{ fontFamily: "'Merriweather Sans',Arial,sans-serif", fontSize: 14,
    fontWeight: 700, color: "#c0126a", margin: "16px 0 8px" }}>{label}. {title}</h3>
);

const SubSubHd = ({ id, label, title }) => (
  <h4 id={id} style={{ fontFamily: "'Merriweather Sans',Arial,sans-serif", fontSize: 13.5,
    fontWeight: 700, color: "#c0126a", margin: "14px 0 7px" }}>{label}. {title}</h4>
);
...
const ActivityBox = ({ num, sub, children }) => (
  <div style={{ border: "1.5px solid #888", borderLeft: "5px solid #c0126a", margin: "18px 0" }}>
    ...
    {sub && <div style={{ textAlign: "center", color: "#c0126a", fontStyle: "italic",
...
const KBBox = ({ children }) => (
  <div style={{ border: "2px solid #c0126a", margin: "20px 0" }}>
    <div style={{ background: "#c0126a", color: "#fff",
      fontFamily: "'Merriweather Sans',Arial,sans-serif",
...
const HamburgerBtn = ({ open, setOpen }) => {
  ...
  return (
    <button onClick={() => setOpen(o => !o)} style={{
      ...
      width: 36, height: 36, background: P_COLOR,
...
const Backdrop = ({ open, onClick }) => open ? (
  ...
  <div style={{ position: "relative", marginTop: 30 }}>
    ...
    <div style={{
      ...
      <p style={{
        ...
        Sections 1.6–1.7 including Colloidal Solutions, Emulsions, Properties of Colloids, Concentration of Solution and more.
      </p>
      <button style={{
...
const content_b1 = [
  ...
  // PAGE 1
  <div key="p1" style={{display:"contents"}}>
  ...
  // PAGE 2
  <div key="p2" style={{display:"contents"}}>
  ...
  // PAGE 3
  <div key="p3" style={{display:"contents"}}>
  ...
  // PAGE 4
  <div key="p4" style={{display:"contents"}}>
    <p style={{ textIndent: 28, textAlign: "justify" }}>
  ...
  // PAGE 5
  <div key="p5" style={{display:"contents"}}>
  ...
  // PAGE 6
  <div key="p6" style={{display:"contents"}}>
    <p style={{ textIndent: 28, textAlign: "justify" }}>
  ...
  // PAGE 7
  <div key="p7" style={{display:"contents"}}>
  ...
  // PAGE 8
  <div key="p8" style={{display:"contents"}}>
  ...
  // PAGE 9
  <div key="p9" style={{display:"contents"}}>
...
// ── LOCKED CONTENT (from section 1.6 onwards) ────────────────
const locked_b1 = [
  <div key="p9b" style={{display:"contents"}}>
...
const content_b2 = [
  ...
  // PAGE 11
  <div key="p11" style={{display:"contents"}}>
    <p style={{ textIndent: 28, textAlign: "justify" }}>
  ...
  // PAGE 12
  <div key="p12" style={{display:"contents"}}>
  ...
  // PAGE 13
  <div key="p13" style={{display:"contents"}}>
    <p style={{ textIndent: 28, textAlign: "justify" }}>
  ...
  // PAGE 14
  <div key="p14" style={{display:"contents"}}>
  ...
  // PAGE 15
  <div key="p15" style={{display:"contents"}}>
  ...
  // PAGE 16
  <div key="p16" style={{display:"contents"}}>
  ...
  // PAGE 17
  <div key="p17" style={{display:"contents"}}>
  ...
  // PAGE 18
  <div key="p18" style={{display:"contents"}}>
    <NumericalSection topic="CONCENTRATION AND SOLUBILITY">
...
// ── CONCAT ARRAYS ────────────────────────────────────────────
const freeContent = [...content_b1];
const lockedContent = [...locked_b1, ...content_b2];

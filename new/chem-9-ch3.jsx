  ...
  return (
    <button
      ...
      style={{
        ...
        background: P_COLOR, border: "none", borderRadius: 6,
    ...
    >
      {[0,1,2].map(i => (
        <span key={i} style={{ display: "block", width: 22, height: 2.5, background: "#fff", borderRadius: 2, transition: "all 0.2s" }} />
      ))}
    </button>
  );
}
...
function Backdrop({ open, setOpen }) {
  ...
  return (
    <div
      ...
      style={{ position: "fixed", inset: 0, zIndex: 1050, background: "rgba(0,0,0,0.25)" }}
    />
  );
}
...
function Sidebar({ open, setOpen, tocItems }) {
  return (
    <div style={{
      ...
      width: 310, height: "100vh", overflowY: "auto",
      background: "#fff", boxShadow: "2px 0 18px rgba(0,0,0,0.13)",
      transform: open ? "translateX(0)" : "translateX(-320px)",
      transition: "transform 0.28s cubic-bezier(.4,0,.2,1)",
      padding: "56px 0 24px 0"
    }}>
      <div style={{ padding: "0 18px 12px 18px", borderBottom: `2px solid ${P_COLOR}`, marginBottom: 8 }}>
        <span style={{ color: P_COLOR, fontFamily: "'Open Sans', sans-serif", fontWeight: 800, fontSize: 14, letterSpacing: 0.5 }}>TABLE OF CONTENTS</span>
      </div>
      {tocItems.map(item => (
        <div
          key={item.id}
          ...
          style={{
            padding: item.level === 1 ? "7px 18px" : item.level === 2 ? "5px 28px" : "4px 38px",
            cursor: "pointer", fontSize: item.level === 1 ? 13.5 : item.level === 2 ? 13 : 12.5,
            fontWeight: item.level === 1 ? 700 : 400, color: item.level === 1 ? P_COLOR : "#333",
...
const content_b1 = [
  ...
  <ActivityBox key="act-3-1" num="3.1" sub="To verify that mass does not change during a physical change">
    ...
    <Fig
      key="fig-3-1"
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-02.jpg?height=267&width=745&top_left_y=1293&top_left_x=689"
      caption="Fig. 3.1"
    />
    ...
    <Fig
      key="fig-3-2"
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-02.jpg?height=302&width=1027&top_left_y=1961&top_left_x=550"
      caption="Fig. 3.2"
    />
  </ActivityBox>,
  ...
  <ActivityBox key="act-3-2" num="3.2" sub="To verify that mass does not change during a chemical change">
    ...
    <Fig
      key="fig-3-3"
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-03.jpg?height=652&width=1495&top_left_y=1228&top_left_x=317"
...
const content_b2 = [
  ...
  <KBBox key="kb-measuring">
    ...
    <Fig
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-06.jpg?height=141&width=931&top_left_y=1989&top_left_x=623"
      caption="Fig. 3.4"
    />
    <p style={{ fontSize: 14, lineHeight: 1.75, margin: "0 0 4px 0" }}>
    ...
    <Fig
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-07.jpg?height=785&width=780&top_left_y=371&top_left_x=696"
      caption="Fig. 3.5"
    />
    <p style={{ fontSize: 14, lineHeight: 1.75, margin: "0 0 4px 0" }}>
    ...
    <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center", margin: "8px 0" }}>
      <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-07.jpg?height=399&width=366&top_left_y=1589&top_left_x=386" caption="Fig. 3.6 (Stop Watch)" width="30%" />
      <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-07.jpg?height=371&width=368&top_left_y=1615&top_left_x=842" caption="Fig. 3.7 (Stop Clock)" width="30%" />
      <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-07.jpg?height=369&width=482&top_left_y=1615&top_left_x=1293" caption="Fig. 3.8 (Digital Balance)" width="30%" />
    </div>
  ...
  <Fig
    key="fig-3-9"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-10.jpg?height=506&width=609&top_left_y=1671&top_left_x=1134"
  ...
  <Fig
    key="fig-3-10"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-11.jpg?height=472&width=739&top_left_y=824&top_left_x=1082"
...
const content_b3 = [
  ...
  <Fig
    key="fig-3-11"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-15.jpg?height=235&width=590&top_left_y=459&top_left_x=730"
  ...
  <Fig
    key="fig-3-12"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-15.jpg?height=265&width=1348&top_left_y=1138&top_left_x=386"
  ...
  <Fig
    key="fig-3-13"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-15.jpg?height=248&width=300&top_left_y=1628&top_left_x=878"
  ...
  <Fig
    key="fig-3-14"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-16.jpg?height=503&width=515&top_left_y=348&top_left_x=1258"
  ...
  <Fig
    key="fig-3-15"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-16.jpg?height=260&width=619&top_left_y=1332&top_left_x=797"
  ...
  <Fig
    key="fig-3-16"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-16.jpg?height=293&width=697&top_left_y=1772&top_left_x=726"
  ...
  <ActivityBox key="act-3-3" num="3.3" sub="To construct simple models of covalent molecules using eco-friendly materials to show how atoms are connected">
    ...
    <Fig src="https://cdn.mathpix.com/snip/images/2ebIfrmWviHwHe758U0lS44JK_Q5JiilKvpivyND6Io.original.fullsize.png" caption="" width="80%" />
    <p style={{ fontSize: 14, lineHeight: 1.75, margin: "0 0 4px 0" }}><strong>(<em>b</em>) Triatomic molecules</strong></p>
    <Fig src="https://cdn.mathpix.com/snip/images/2cl2jpMJByfoNVN5W7Auz773a8p39omkvGXthWJ0Hag.original.fullsize.png" caption="" width="80%" />
    <p style={{ fontSize: 14, lineHeight: 1.75, margin: "0 0 4px 0" }}><strong>(<em>c</em>) Tetratomic molecules</strong></p>
    <Fig src="https://cdn.mathpix.com/snip/images/-ur8_ycC054-xllZfw8pdWxVLuGGO0Tg0Fyea0qjAbQ.original.fullsize.png" caption="" width="80%" />
    <p style={{ fontSize: 14, lineHeight: 1.75, margin: "0 0 4px 0" }}><strong>(<em>d</em>) Pentatomic molecules</strong></p>
    <Fig
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-20.jpg?height=392&width=235&top_left_y=446&top_left_x=945"
...
const content_b4 = [
  ...
  <Fig key="b4-fig-s383-1" src="https://cdn.mathpix.com/snip/images/T3V-D_702fAdSNgRmCcs_iHoxM7u_oGrAP5dZjztYO0.original.fullsize.png" caption="" width="100%" />,
  <Fig key="b4-fig-s383-2" src="https://cdn.mathpix.com/snip/images/wdWhf3RIWA2qaL6oMszWTDmfB5TzB7LDe1K488rOB3Y.original.fullsize.png" caption="" width="100%" />,
  ...
  <Fig key="b4-fig-s384-1" src="https://cdn.mathpix.com/snip/images/gA8ZdTtVVxi_WUtuARMqLNbRv-b6dmmkpRU6a5oVgN8.original.fullsize.png" caption="" width="100%" />,
  <Fig key="b4-fig-s384-2" src="https://cdn.mathpix.com/snip/images/08mb-rvw1zjdDhttjW2UyR2dPYk1rEEQYLTuxClTMRc.original.fullsize.png" caption="" width="100%" />,
  ...
  <Fig key="b4-fig-s385-1" src="https://cdn.mathpix.com/snip/images/vzP60Egi9zG0UOTkVZLrJGu9cei0YcP2dQsAecRUcE8.original.fullsize.png" caption="" width="100%" />,
  <Fig key="b4-fig-s385-2" src="https://cdn.mathpix.com/snip/images/JACdmO5iijG-gxWRtdOikwk-l5MFhgna9-DnXqdANhU.original.fullsize.png" caption="" width="100%" />,
  ...
  <NumericalSection key="num-formulas" topic="WRITING CHEMICAL FORMULAE">
    ...
    <Fig key="b4-fig-ex1" src="https://cdn.mathpix.com/snip/images/8XzRH1udadEZFrhMxed5h-I8JgLgzeacMuJFwtNx0ek.original.fullsize.png" caption="" width="100%" />
    ...
    <Fig key="b4-fig-ex2-1" src="https://cdn.mathpix.com/snip/images/63c4Xn1Pb9jXUXwYf6EfWpShSgVmiuYKjVs5_Guuy7E.original.fullsize.png" caption="" width="100%" />
    <p key="b4-np-f-ex2-s2" style={{ fontSize: 14, lineHeight: 1.9, margin: "0 0 8px 0" }}>
      (<em>ii</em>) Formula of oxide when X has valency = 5:
    </p>
    <Fig
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=158&width=857&top_left_y=395&top_left_x=635"
    ...
    <Fig
      src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=242&width=895&top_left_y=795&top_left_x=617"
  ...
  <ActivityBox key="act-3-4" num="3.4" sub="To design an educational game to write chemical formulas using symbols.">
    ...
    <div style={{ display: "flex", gap: 12, alignItems: "flex-end", flexWrap: "wrap", margin: "8px 0" }}>
      <div style={{ textAlign: "center" }}>
        <img src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=184&width=185&top_left_y=1396&top_left_x=524" style={{ maxWidth: 120 }} alt="1 Tab" />
        <div style={{ fontSize: 13, marginTop: 4 }}>Na<Sup c="+" /> (1 Tab)</div>
      </div>
      <div style={{ textAlign: "center" }}>
        <img src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=184&width=299&top_left_y=1396&top_left_x=786" style={{ maxWidth: 180 }} alt="2 Tabs" />
        <div style={{ fontSize: 13, marginTop: 4 }}>Ca<Sup c="2+" /> (2 Tabs)</div>
      </div>
      <div style={{ textAlign: "center" }}>
        <img src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=186&width=416&top_left_y=1394&top_left_x=1185" style={{ maxWidth: 240 }} alt="3 Tabs" />
    ...
    <div style={{ display: "flex", gap: 12, alignItems: "flex-end", flexWrap: "wrap", margin: "8px 0" }}>
      <div style={{ textAlign: "center" }}>
        <img src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=179&width=181&top_left_y=1710&top_left_x=526" style={{ maxWidth: 120 }} alt="1 Notch" />
        <div style={{ fontSize: 13, marginTop: 4 }}>Cl<Sup c="−" /> (1 Notch)</div>
      </div>
      <div style={{ textAlign: "center" }}>
        <img src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=184&width=295&top_left_y=1705&top_left_x=786" style={{ maxWidth: 180 }} alt="2 Notches" />
        <div style={{ fontSize: 13, marginTop: 4 }}>SO<Sub c="4" /><Sup c="2−" /> (2 Notches)</div>
      </div>
      <div style={{ textAlign: "center" }}>
        <img src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=190&width=413&top_left_y=1703&top_left_x=1188" style={{ maxWidth: 240 }} alt="3 Notches" />
    ...
    <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-29.jpg?height=276&width=441&top_left_y=2109&top_left_x=842" caption="NaCl formation" width="40%" />
    <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-30.jpg?height=285&width=732&top_left_y=363&top_left_x=694" caption="CaCl₂ formation" />
    <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-30.jpg?height=295&width=743&top_left_y=674&top_left_x=691" caption="Na₂SO₄ formation" />
    <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-30.jpg?height=291&width=622&top_left_y=1001&top_left_x=751" caption="CaO formation" />
    <p style={{ fontSize: 14, lineHeight: 1.75, margin: "6px 0 4px 0" }}>
      Similarly, building formulas of sodium sulphate and sodium phosphate are represented below in a simplified manner :
    </p>
    <Fig src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-30.jpg?height=454&width=719&top_left_y=1405&top_left_x=704" caption="Na₂SO₄ and Na₃PO₄ simplified" />
  ...
  <Fig
    key="fig-3-17"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-31.jpg?height=439&width=788&top_left_y=904&top_left_x=1039"
...
const content_b5 = [
  ...
  <Fig key="b5-fig-lewis-symbols"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-34.jpg?height=94&width=657&top_left_y=794&top_left_x=734"
  ...
  <Fig key="b5-fig-cl-ion"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-34.jpg?height=124&width=541&top_left_y=1993&top_left_x=794"
  ...
  <Fig key="b5-fig-nacl-form"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-35.jpg?height=152&width=654&top_left_y=401&top_left_x=734"
  ...
  <Fig key="b5-fig-caf2"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-35.jpg?height=286&width=845&top_left_y=915&top_left_x=640"
  ...
  <Fig key="b5-fig-mgo"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-35.jpg?height=137&width=793&top_left_y=1314&top_left_x=666"
  ...
  <Fig key="b5-fig-mgbr2"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-35.jpg?height=306&width=879&top_left_y=1506&top_left_x=623"
  ...
  <Fig key="b5-fig-cas"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-35.jpg?height=139&width=801&top_left_y=1920&top_left_x=663"
  ...
  <Fig key="b5-fig-na2s"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-35.jpg?height=196&width=785&top_left_y=2161&top_left_x=670"
  ...
  <Fig key="b5-fig-cl2"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-36.jpg?height=147&width=671&top_left_y=844&top_left_x=728"
  ...
  <Fig key="b5-fig-hcl"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-36.jpg?height=102&width=605&top_left_y=1091&top_left_x=760"
  ...
  <Fig key="b5-fig-cov-examples"
    src="https://cdn.mathpix.com/snip/images/XO2xKfd2WF9GNkNeFyeu_njDkIYZLndSw3_HIbgmRqc.original.fullsize.png"
  ...
  <Fig key="b5-fig-nacl-crystal"
    src="https://cdn.mathpix.com/cropped/89caa104-3814-45db-b6c9-e5a71455ef55-37.jpg?height=540&width=489&top_left_y=902&top_left_x=816"
...
export default function Chapter3() {
  ...
  return (
    <div style={{ fontFamily: "Georgia, serif", color: "#222", background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "0 48px 60px 68px", maxWidth: 900, margin: "0 auto" }}>
        {allContent}
      </div>
    </div>
  );
